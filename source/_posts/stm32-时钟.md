...
tags: [嵌入式, mcu, stm32]
---
- [stm32 时钟系统](#stm32-时钟系统)
  - [4个时钟源](#4个时钟源)
  - [锁相环pll](#锁相环pll)
  - [系统时钟 sysclk](#系统时钟-sysclk)
  - [实验](#实验)

# stm32 时钟系统

首先肯定得有时钟系统，stm32f103的时钟系统比较复杂，不像简单的51，就一个系统时钟解决一切。

stm32主频可到`72Mhz`，但是不是所有的外设都需要这么高的时钟。有些如看门狗以及 RTC 只需要`几十 kHZ` 的时钟即可
